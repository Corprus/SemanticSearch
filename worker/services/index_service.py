...
from worker.infrastructure.dummy_embedding_model import DummyEmbeddingModel
...
class IndexService:
    ...
    def index_document(self, user_id: UUID, document_id: UUID) -> list[float]:
        ...
        self._vector_index.upsert(user_id=user_id, doc_id=document_id, vector=vector, model_name=self._embedding_model.name)
        return vector
